...
format:
  revealjs:
    ...
    chalkboard: 
      buttons: false
    preview-links: auto
    logo: NHSR_Pycom_images/quarto.png
    css: styles.css
...
::: {.column width="60%"}
![](NHSR_Pycom_images/03 API request response.png)
:::
:::::
...
::::: columns
::: {.column width="40%"}
![](NHSR_Pycom_images/04 httr2_package_tidyverse.png)
:::
...
- **Shiny App example**
![](NHSR_Pycom_images/05 Shiny app example.png){width="50%"}
...
![](NHSR_Pycom_images/06 Geospatial data Shiny app.png){width="50%"}
