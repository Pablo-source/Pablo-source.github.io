...
-   **Shiny App example** ![](figures/05%20Shiny%20app%20example.png){width="50%"}

-   <https://github.com/Pablo-source/RPYSOC_2024_Docker_Shiny>

-   **Shiny app Using Leaflet and geospatial data**

-   <https://github.com/Pablo-source/Basic-Shiny-app> ![](figures/06%20Geospatial%20data%20Shiny%20app.png){width="50%"}
...
-   `OAuth 2.0`: Ideal for third-party integrations. Uses tokens for secure, delegated access.
