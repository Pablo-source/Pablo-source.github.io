...
::::: columns
::: {.column width="40%"}
![](figures/04 httr2_package_tidyverse.png){width="30%"}
:::
...
-   **Shiny App example** ![](figures/08_Basic_Shiny_app.png){width="30%"}
...
-   <https://github.com/Pablo-source/Basic-Shiny-app> ![](figures/09_Shiny_App_advanced.png){width="50%"}
